...
def main():
    ...
    dim = torchattacks.DIFGSM(model, eps=0.3, alpha=0.02, steps=40, decay=0.0, resize_rate=0.9, diversity_prob=0.5, random_start=False)  # 적대적(기만) 공격 방법 정의
    print(dim)
    ...
    for image, label in test_loader:
        ...
        adv_exam = dim(image, label) # 적대적 예제 생성
